...
<section id="works" class="works">
    <div class="container">
        <div class="section-header">
            <h2 style="color: #383F29">chia sẻ kinh nghiệm</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-how-works">
                        ...
                        <button class="welcome-hero-btn how-work-btn" onclick="window.location.href='costume.php'">
                            Đến
                        </button>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="single-how-works">
                        ...
                        <h2><a href="tool.php">Dụng cụ</h2>
                        <p>
                            Những đồ dùng cần thiết phải mang theo
                        </p>
...
<section id="explore" class="explore">
    <div class="container">
        <div class="section-header">
            <h2 style="color: #383F29">địa điểm</h2>
                            ...
                            <div class="explore-person">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="explore-person-img">
                                            <a href="#">
                                                <img src="contents/2c0aa0661c9bb5c5ec8a.jpg" alt="explore person">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-10">
